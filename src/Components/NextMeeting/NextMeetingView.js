...
function NextMeetingView(props){
    ...
    return (<div className={"container"}>
        ...
        <table className="table table-sm bg-white table-borderless" id={"table"}>
            ...
            <tbody>
                <tr><td>Type</td></tr>
                <tr><td className={"text-muted"}>physical</td></tr>
                <tr><td>Time & Date</td></tr>
                <tr><td className={"text-muted"}>2022/06/26 15:00</td></tr>
                <tr><td>Location</td></tr>
                <tr><td className={"text-muted"}>Cafe blåbär</td></tr>
                <tr><td className={"text-muted"}>Fleminggatan 53, 112 32 Stockholm</td></tr>
            </tbody>
        </table>
    </div>);
}
